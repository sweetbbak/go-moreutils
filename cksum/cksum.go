// Big thanks to user Rudu on SO.
// https://stackoverflow.com/questions/63541233/crc32-checksum-calculation-via-go
package main
...
func _checksum(file *os.File, polynomial uint32) error {
...
func checksum(file *os.File) (uint32, int, error) {
